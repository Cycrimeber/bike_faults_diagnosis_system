...
?>
	...
	<head>
		...
		<title>Jincheng Fault Diagnosis | Admin Dashboard</title>
										...
										<div class="col-md-3">
											<div class="panel panel-default">
												<div class="panel-body bk-success text-light">
													<div class="stat-panel text-center">
														<?php
														$sql1 = "SELECT id from faults_diagnosis ";
														$query1 = $dbh->prepare($sql1);;
														$query1->execute();
														$results1 = $query1->fetchAll(PDO::FETCH_OBJ);
														$faults_diagnosis = $query1->rowCount();
														?>
														<div class="stat-panel-number h1 "><?php echo htmlentities($faults_diagnosis); ?></div>
														<div class="stat-panel-title text-uppercase">Listed Diagnosis</div>
													</div>
												</div>
										...
										<div class="col-md-3">
											<div class="panel panel-default">
												<div class="panel-body bk-info text-light">
													<div class="stat-panel text-center">
														<?php
														$sql2 = "SELECT id from users_faults_diagnosis ";
														$query2 = $dbh->prepare($sql2);
														$query2->execute();
														$results2 = $query2->fetchAll(PDO::FETCH_OBJ);
														$diagnosed = $query2->rowCount();
														?>

														<div class="stat-panel-number h1 "><?php echo htmlentities($diagnosed); ?></div>
														<div class="stat-panel-title text-uppercase">Total Diagnosed</div>
													</div>
												</div>
												<a href="view_diagnosis.php" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
											</div>
										</div>
										<div class="col-md-3">
											<div class="panel panel-default">
