	<nav class="ts-sidebar">
		<ul class="ts-sidebar-menu">
			...
			<li><a href="#"><i class="fa fa-sitemap"></i> Diagnosis</a>
				<ul>
					<li><a href="create_diagnosis.php"><i class="fa fa-cog"></i>Create Diagnosis</a></li>
					<li><a href="diagnose.php"><i class="fa fa-wrench"></i>Diagnose Fault</a></li>
					<li><a href="view_diagnosis.php"><i class="fa fa-cog"></i>Diagnosis Report</a></li>
				</ul>
			</li>
